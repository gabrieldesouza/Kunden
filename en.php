                ...
                <div class="navbar navbar-inverse navbar-static-top">
                  <div class="container">
                    ...
                    <nav class="navArea">
                      ...
                      <li class="menuItem"><a href="#about">La Empresa</a></li>
                      <li class="menuItem"><a href="#services">Soluciones</a></li>
                      <li class="menuItem"><a href="#works">Portafolio</a></li>
                      <li class="menuItem"><a href="#team">ERP</a></li>
                      <li class="menuItem"><a href="#testimonial">Servicios</a></li>
                      <li class="menuItem"><a href="#suporte">Soporte</a></li>
            ...
            <div class="slide">
              ...
              <div class="container hedaer-inner">
                  <div class="bannerText">
                  	<h1>Kunden </h1>
                    <h3>Personas hacen la diferencia.</h3>
                    <p>Con muchos años en el negocio, absorber conocimiento nuestros conceptos innovadores. Que nos permitió trabajar con diferentes segmentos, búsqueda de calidad de nuestros proyectos.</p>
                    <p class="banner-link"><a href="#about" class="smooth">Nuestra introducción <i class="fa fa-chevron-down"></i></a></p>
                   </div>
               </div>
              <!--header text end-->
              ...
              <div class="container hedaer-inner">
                  <div class="bannerText">
                    ...
                    <h3>Personas hacen la diferencia.</h3>
                    <p>Con muchos años en el negocio, absorber conocimiento nuestros conceptos innovadores. Que nos permitió trabajar con diferentes segmentos, búsqueda de calidad de nuestros proyectos.</p>
                    <p class="banner-link"><a href="#services" class="smooth">Nuestras soluciones <i class="fa fa-chevron-down"></i></a></p>
                   </div>
               </div>
              <!--header text end-->
...
<!--Welcome section start -->
  <section class="white_section section_gap" id="about">
    <div class="container">
      <div class="heading">
        <h1><span>Bien viniendo a</span> Kunden</h1>
      </div>
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noPaddLeft welcome">
          <h1 class="welcome_heading font-light">Sistemas para gestión empresarial.</h1>
        </div>
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 welcomr_text">
          <p>La Kunden Systems nació de la gana de hacer y crear nuevos caminos, superar desafíos y crecer, para así presentar nuevas propuestas y oportunidades al mercado. Nuestro objetivo es la integración entre el sistema y cliente. Contando con un equipo de profesionales especializados, capacitados a planear y utilizar estrategias inteligentes, en la búsqueda continua de la consolidación de resultados. Comprendemos la realidad de cada negocio, adaptando nuestra solución al tamaño de su empresa.</p>
          <p>Muy más que un software y mucho además de desarrollar un sistema para gestión empresarial, la Kunden Systems oferta un paquete completo de asesoría para realmente obtener resultados en la aplicación del software en la gestión, optimizando los procesos de organización en su empresa.</p>
        </div>
      </div>
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-magic"></i></span>
            <h3>Objetivos</h3>
            <p>Alcanzar resultados de alto impacto para nuestros clientes agregando valor a sus negocios, fortaleciendo sus relaciones con el mercado en general.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-leaf"></i></span>
            <h3>Ideas innovadoras</h3>
            <p>Siempre con un paso el frente pensando en el futuro y en el que hay de mejor para crear innovadores proyectos en el mercado.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-paper-plane"></i></span>
            <h3>Soporte</h3>
            <p>Atención las dudas operacionales en la utilización del sistema, cambios determinados por legislación y nuevas versiones del producto.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="orange_section section_gap" id="services">
    <div class="container">
      <div class="heading">
        <h1><span>Soluciones</span> empresariales</h1>
      </div>
      <div class="row sec_top_gp">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/kundenerp.png" ></span>
          <h5>Kunden ERP</h5>
          <p>El sistema de gestión fue desarrollado para ser una herramienta estratégica en la gestión de pequeñas a grandes empresas... </p>
          <div class="text-center button-container"><a class="anchor" id="demo01" href="#animatedModal">sepa más</a></div>

        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/romanscad.png"></span>
          <h5>Romans CAD</h5>
          <p>Si quiere ganar en productividad y obtener el mejor ROI del mercado, tiene que apostar en una solución de CAD/PDM, Romans CAD es la elección...</p>
          <div class="text-center button-container"><a class="anchor" id="demo02" href="#lightSpeedIn">sepa más</a></div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/ivendre.png"></span>
          <h5>iVendre</h5>
          <p>iVendre uno modulo de gestión, control y venta de sus productos, la solución que usted busca para maximizar su productividad de ventas...</p>
          <div class="text-center button-container"><a class="anchor" id="demo03" href="#teste">sepa más</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="white_section protfolio section_gap" id="works">
    <div class="container">
      <div class="heading">
        <h1><span>Nuestros </span>proyectos</h1>
      </div>
    </div>
    <div class="row sec_top_gp">
    ...
    <div class="container">
      ...
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 meet_team_left">
          ...
          <p>El sistema de gestión fue desarrollado para ser una herramienta estratégica en la gestión de pequeñas a grandes empresas, siempre con el foco en la realidad de cada cliente. Este sistema es compuesto por varios módulos integrados, que optimizan y agilizan todos los procesos comerciales, administrativos e industriales, proporcionando datos seguros y confiables para las tomas de decisión.</p>
		<h1 class="welcome_heading font-light"><b>Curtumes</b></h1>
		<p>ERP completo para curtumes <b>(Industrial, Comercial y Administrativo)</b>, enfocado especialmente en la gestión de la producción, desde la planificación la contraloría. Especializado en automatización de suelo de fábrica, integrado con máquinas y dispositivos, clasificación con <b>control de marca (proveedor)</b>y rastreabilidad de lote, recolección de datos en tiempo real a través de <b>dispositivos móviles (tablets/desktops) con lectura de códigos de barras</b>, control de consumos (materias-primas e insumos), fórmulas de fulões (Caleiro/Curtimento/Recurtimento) y acabado que integrados con sistemas de gestión de recetas (automatización de fulões) y/o balanzas electrónicas garantizan praticidade y fiabilidad de la información. Coste previsto x real con control de rendimiento por pedido/lote/etc. <b>Garantizando un análisis confiable de la rentabilidad de su curtume</b>. Único ERP que controla curtume así como fábrica de calzados (seguridad entre otros).</p>
        </div>
      ...
      <div class="row sec_top_gp">
        ...
        <div class="footerTopContent">
          ...
          <ul class="slides testimonialText list-unstyled">
            <li>
              <p class="font-openBold">Integración de sistemas CAD/CAM con el Kunden ERP. Creación de modelos de indicadores de desempeño, proporcionando subsidios para la planificación del negocio. Gestión de procesos operacionales y administrativos, con enfoque en reducción de costes y mejoría de resultados.</p>
              <h3 class="uppercase">Asesoría empresarial</h3>
            </li>
            <li>
              <p class="font-openBold">Especificaciones para atender particularidades de cada empresa, preservando los diferenciales competitivos a través de aplicaciones desarrolladas bajo-medida.</p>
              <h3 class="uppercase">Proyectos específicos</h3>
            </li>
            <li>
              <p class="font-openBold">Califica usuarios en todos los niveles, garantizando la rápida absorción de los beneficios del sistema y alta productividad.</p>
              <h3 class="uppercase">Entrenamiento</h3>
            </li>
          </ul>
        </div>
      </div>
...
<p>Atención las dudas operacionales en la utilización del sistema, cambios determinados por legislación y nuevas versiones del producto.</p>
  ...
  <section class="white_section section_gap"  id="contact">
    <div class="container">
      <div class="heading">
        <h1><span>ENTRE EN </span> CONTACTO</h1>
      </div>
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <h3 class="font-bold uppercase">Escritorio informaciones</h3>
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <p>Kunden system<br>
                Carretera BR 116, nº. 8994, km 222, Bairro Bela Vista<br> Dois Irmãos - RS, CEP: 93950-000</p>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <h4>Telefone</h4>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <h4>Horario de funcionamiento</h4>
              <p>Segunda la Sexta - 7:30 ás 12:00 e 13:00 ás 17:18<br>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <h3 class="font-bold uppercase">Envíe un mensaje!</h3>
          <div id="message"></div>
          <form method="post" action="php/contact.php" name="cform" id="cform">
        <div class="form-row clearfix">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 first"><input name="fname" id="fname" type="text" placeholder="Premiero nome" class="normal"></div>
          ...
          <input type="submit" id="submit" name="send" class="button" value="Envíe mensaje">
  ...
  <footer class="footer white_section">
    <div class="container">
      <div class="row">
        <div class="pull-left">
          <p>&copy; 2016 Kunden system. Todos derechos reservados.</p>
        </div>
...
<script src="js/custom.js"></script>
       ...
       <div id="animatedModal">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2" style="color: #fff;">
              <?php
                $ini_array = parse_ini_file("KundenERP/espanhol.ini", true);
    ...
    <p> <br> </p>
        ...
        <div id="lightSpeedIn" style="background-color: #5096c8;">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
                          <?php
                $ini_array = parse_ini_file("RomansCad/espanhol.ini", true);
      ...
      <?php  }
        ...
        <div id="teste">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
                                      <?php
                $ini_array = parse_ini_file("iVendre/espanhol.ini", true);
