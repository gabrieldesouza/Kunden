...
if(trim($Nome) == '') {
	echo '<div class="error_message">Insira um nome.</div>';
	exit();
} else if(trim($Sobrenome) == '') {
	echo '<div class="error_message">Insira um sobrenome.</div>';
	exit();
} else if(trim($Email) == '') {
	echo '<div class="error_message">Insira um email valido.</div>';
	exit();
} else if(!isEmail($Email)) {
	echo '<div class="error_message">Voce ja enviou este email, por favor tente novamente mais tarde.</div>';
	exit();
}
