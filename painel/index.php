...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
  <ul style="display: block;">
    ...
    <li class="submenu active"> <a href="#"><i class="icon icon-list"></i> <span>KundenERP</span> </a>
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>Inicio</a> <a href="#" class="tip-bottom" data-original-title="">KundenERP</a> <a href="#" class="current">Português</a> </div>
  <h1>KundenERP Portugês</h1>
</div>
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          ...
          if(isset($_POST['SubmitButton'])){ //check if form was submitted
            ...
            $ini = new INI('../KundenERP/portugues.ini');

            $ini->data['KundenERP']['titulo'] = $_POST['titulo'];

            $ini->data['KundenERP']['texto'] = $_POST['texto'];

            $ini->data['KundenERP']['imagem1'] = $_POST['imagem1'];

            $ini->data['KundenERP']['imagem2'] = $_POST['imagem2'];

            $ini->data['KundenERP']['image3'] = $_POST['imagem3'];
