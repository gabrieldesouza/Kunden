...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>Inicio</a> <a href="#" class="tip-bottom" data-original-title="">KundenERP</a> <a href="#" class="current">Inglês</a> </div>
  <h1>KundenERP Inglês</h1>
</div>
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          ...
          if(isset($_POST['SubmitButton'])){ //check if form was submitted
            ...
            $ini = new INI('../KundenERP/ingles.ini');
