...
<li class="submenu active"> <a href="#"><i class="icon icon-list"></i> <span>RomansCad</span> </a>
      <ul style="display: none;">
...
<li class="submenu"> <a href="#"><i class="icon icon-list"></i> <span>iVendre</span> </a>
      <ul style="display: none;">
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>Inicio</a> <a href="#" class="tip-bottom" data-original-title="">RomansCAD</a> <a href="#" class="current">Português</a> </div>
  <h1>RomansCAD Portugês</h1>
</div>
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          ...
          if(isset($_POST['SubmitButton'])){ //check if form was submitted
            ...
            $ini = new INI('../RomansCad/portugues.ini');

            $ini->data['RomansCad']['titulo'] = $_POST['titulo'];

            $ini->data['RomansCad']['texto'] = $_POST['texto'];

            $ini->data['RomansCad']['imagem1'] = $_POST['imagem1'];

            $ini->data['RomansCad']['imagem2'] = $_POST['imagem2'];

            $ini->data['RomansCad']['image3'] = $_POST['imagem3'];
