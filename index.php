                ...
                <div class="navbar navbar-inverse navbar-static-top">
                  <div class="container">
                    ...
                    <nav class="navArea">
                      ...
                      <li class="menuItem"><a href="#about">A Empresa</a></li>
                      <li class="menuItem"><a href="#services">Soluções</a></li>
                      <li class="menuItem"><a href="#works">Portfolio</a></li>
                      <li class="menuItem"><a href="#team">ERP</a></li>
                      <li class="menuItem"><a href="#testimonial">Serviços</a></li>
                      <li class="menuItem"><a href="#suporte">Suporte</a></li>
            ...
            <div class="slide">
              ...
              <div class="container hedaer-inner">
                  <div class="bannerText">
                  	<h1>Kunden </h1>
                    <h3>Pessoas fazem a diferença.</h3>
                    <p>Com muitos anos neste ramo, absorvemos conhecimentos inovando nossos conceitos. O que nos permitiu atuar com diferentes segmentos, primando pela qualidade de nossos projetos.</p>
                    <p class="banner-link"><a href="#about" class="smooth">Nossa introdução <i class="fa fa-chevron-down"></i></a></p>
                   </div>
               </div>
              <!--header text end-->
              ...
              <div class="container hedaer-inner">
                  <div class="bannerText">
                    ...
                    <h3>Pessoas fazem a diferença.</h3>
                    <p>Com muitos anos neste ramo, absorvemos conhecimentos inovando nossos conceitos. O que nos permitiu atuar com diferentes segmentos, primando pela qualidade de nossos projetos.</p>
                    <p class="banner-link"><a href="#services" class="smooth">Nossas soluções <i class="fa fa-chevron-down"></i></a></p>
                   </div>
               </div>
              <!--header text end-->
...
<!--Welcome section start -->
  <section class="white_section section_gap" id="about">
    <div class="container">
      <div class="heading">
        <h1><span>Bem vindo a</span> Kunden</h1>
      </div>
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noPaddLeft welcome">
          <h1 class="welcome_heading font-light">Sistemas para gestão empresarial.</h1>
        </div>
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 welcomr_text">
          <p>A Kunden Systems nasceu da vontade de fazer e criar novos caminhos, superar desafios e crescer, para assim apresentar novas propostas e oportunidades ao mercado. Nosso objetivo é a integração entre o sistema e cliente. Contando com uma equipe de profissionais especializados, capacitados a planejar e utilizar estratégias inteligentes, na busca contínua da consolidação de resultados. Compreendemos a realidade de cada negócio, adaptando nossa solução ao tamanho da sua empresa.</p>
          <p>Muito mais que um software e muito além de desenvolver um sistema para gestão empresarial, a Kunden Systems oferece um pacote completo de assessoria para realmente obter resultados na aplicação do software no gerenciamento, otimizando os processos de organização na sua empresa.</p>
        </div>
      </div>
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-magic"></i></span>
            <h3>Objetivos</h3>
            <p>Alcançar resultados de alto impacto para nossos clientes agregando valor aos seus negócios, fortalecendo suas relações com o mercado em geral.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-leaf"></i></span>
            <h3>Ideias inovadoras</h3>
            <p>Sempre com um passo a frente pensando no futuro e no que há de melhor para criar inovadores projetos no mercado.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          <div class="welcome_listing"> <span><i class="fa fa-paper-plane"></i></span>
            <h3>Suporte</h3>
            <p>Atendimento as dúvidas operacionais na utilização do sistema, mudanças determinadas por legislação e novas versões do produto. </p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="orange_section section_gap" id="services">
    <div class="container">
      <div class="heading">
        <h1 style="margin-top: 1.5rem"><span>Soluções</span> empresariais</h1>
      </div>
      <div class="row sec_top_gp">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/kundenerp.png" ></span>
          <h5>Kunden ERP</h5>
          <p>O sistema de gestão foi desenvolvido para ser uma ferramenta estratégica na gestão de pequenas a grandes empresas... </p>
          <div class="text-center button-container"><a class="anchor" id="demo01" href="#animatedModal">saiba mais</a></div>

        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/romanscad.png"></span>
          <h5>Romans CAD</h5>
          <p>Se quer ganhar em produtividade e obter o melhor ROI do mercado, tem que apostar numa solução de CAD/PDM, Romans CAD é a escolha... </p>
          <div class="text-center button-container"><a class="anchor" id="demo02" href="#lightSpeedIn">saiba mais</a></div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 ourservice-col"> <span class="ico"><img src="images/ivendre.png"></span>
          <h5>iVendre</h5>
          <p>iVendre um modulo de gestão, controle e venda dos seus produtos, a solução que você procura para maximizar sua produtividade de vendas...</p>
          <div class="text-center button-container"><a class="anchor" id="demo03" href="#teste">saiba mais</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="white_section protfolio section_gap" id="works">
    <div class="container">
      <div class="heading">
        <h1><span>Nossos </span>projetos</h1>
      </div>
    </div>
    <div class="row sec_top_gp">
      ...
      <ul class="portfolioContainer grid row">
        ...
        <li class="mobile col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/iVendre/logo/1.png" alt="">
              <figcaption>
        ...
        <li class=" mobile  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/iVendre/logo/2.png" alt="">
              <figcaption>
          ...
          <div class="lightCon">
            <figure ><img src="images/BI/logo/1.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/1.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/2.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/2.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/3.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/3.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/4.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/4.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/5.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/5.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/6.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/6.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/7.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/7.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/8.png" alt="">
              <figcaption>
                <a rel="lightbox-demo" href="images/BI/8.png" title="BI" class="zoom lb lb_warsaw1">View more</a> </figcaption>
                        ...
                        <li class=" bi  col-xs-6 col-sm-4 col-md-3 col-lg-3">
          <div class="lightCon">
            <figure ><img src="images/BI/logo/9.png" alt="">
              <figcaption>
    ...
    <div class="container">
      ...
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 meet_team_left">
          ...
          <p>O sistema de gestão foi desenvolvido para ser uma ferramenta estratégica na gestão de pequenas a grandes empresas, sempre com o foco na realidade de cada cliente. Este sistema é composto por vários módulos integrados, que otimizam e agilizam todos os processos comerciais, administrativos e industriais, proporcionando dados seguros e confiáveis para as tomadas de decisão.</p>
		<h1 class="welcome_heading font-light"><b>Curtumes</b></h1>
		<p>ERP completo para curtumes <b>(Industrial, Comercial e Administrativo)</b>, focado especialmente na gestão da produção, desde o planejamento a controladoria. Especializado em automação de chão de fábrica, integrado com máquinas e dispositivos, classificação com <b>controle de marca (fornecedor)</b> e rastreabilidade de lote, coleta de dados em tempo real através de <b>dispositivos móveis (tablets/desktops) com leitura de códigos de barras</b>, controle de consumos (matérias-primas e insumos), fórmulas de fulões (Caleiro/Curtimento/Recurtimento) e acabamento que integrados com sistemas de gestão de receitas (automação de fulões) e/ou balanças eletrônicas garantem praticidade e confiabilidade da informação. Custo previsto x real com controle de rendimento por pedido/lote/etc. <b>Garantindo uma análise confiável da rentabilidade de seu curtume</b>. Único ERP que controla curtume assim como fábrica de calçados (segurança entre outros).</p>
        </div>
      ...
      <div class="row sec_top_gp">
        ...
        <div class="footerTopContent">
          ...
          <ul class="slides testimonialText list-unstyled">
            <li>
              <p class="font-openBold">Integração de sistemas CAD/CAM com o Kunden ERP. Criação de modelos de indicadores de desempenho, proporcionando subsídios para o planejamento do negócio. Gestão de processos operacionais e administrativos, com enfoque em redução de custos e melhoria de resultados.</p>
              <h3 class="uppercase">Assessoria empresarial</h3>
            </li>
            <li>
              <p class="font-openBold">Especificações para atender particularidades de cada empresa, preservando os diferenciais competitivos através de aplicativos desenvolvidos sob-medida.</p>
              <h3 class="uppercase">Projetos específicos</h3>
            </li>
            <li>
              <p class="font-openBold">Qualifica usuários em todos os níveis, garantindo a rápida absorção dos benefícios do sistema e alta produtividade.</p>
              <h3 class="uppercase">Treinamento</h3>
            </li>
          </ul>
        </div>
      </div>
...
<p>Atendimento as dúvidas operacionais na utilização do sistema, mudanças determinadas por legislação e novas versões do produto.</p>
    ...
    <div class="container">
      ...
      <div class="row sec_top_gp">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <h3 class="font-bold uppercase">Escritorio informações</h3>
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <p>Kunden system<br>
                Rodovia BR 116, nº. 8994, km 222, Bairro Bela Vista<br> Dois Irmãos - RS, CEP: 93950-000</p>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <h4>Telefone</h4>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              ...
              <p>Segunda a Sexta - 7:30 ás 12:00 e 13:00 ás 17:18<br>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <h3 class="font-bold uppercase">Envie uma mensagem!</h3>
          <div id="message"></div>
          <form method="post" action="php/contact.php" name="cform" id="cform">
        <div class="form-row clearfix">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 first"><input name="fname" id="fname" type="text" placeholder="Primeiro nome" class="normal"></div>
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 last"><input name="lname" id="lname" type="text" placeholder="Sobrenome" class="normal"></div>
          </div>
          <div class="form-row clearfix">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 first">
          <input name="email" id="email" type="email" placeholder="Email" class="normal">
          </div>
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 last"><input name="phone" id="phone" type="text" placeholder="Telefone" class="normal"></div>
          </div>
          <div class="form-row clearfix">
          ...
          <input type="submit" id="submit" name="send" class="button" value="Enviar mensagem">
  ...
  <footer class="footer white_section">
    <div class="container">
      <div class="row">
        <div class="pull-left">
          <p>&copy; 2016 Kunden system. Todos direitos reservados.</p>
        </div>
...
<script type="text/javascript">
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        point = new GPoint(-29.579586, -51.0958417);
...
<script src="js/custom.js"></script>
        ...
        <div id="animatedModal">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2" style="color: #fff;">
              <?php
                $ini_array = parse_ini_file("KundenERP/portugues.ini", true);
    ...
    <p> <br> </p>
        ...
        <div id="lightSpeedIn" style="background-color: #5096c8;">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
                          <?php
                $ini_array = parse_ini_file("RomansCad/portugues.ini", true);
      ...
      <?php  }
        ...
        <div id="teste">
            ...
            <div id="modal-container" class="col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
                                      <?php
                $ini_array = parse_ini_file("iVendre/portugues.ini", true);
